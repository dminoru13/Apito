...
public class CarvingBench extends BlockWithEntity implements BlockEntityProvider {
    ...
    public @Nullable BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new CarvingBenchEntity(pos, state);
    }
    ...
    protected void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if(state.getBlock() != newState.getBlock()) {
            ...
            if(blockEntity instanceof CarvingBenchEntity) {
                ItemScatterer.spawn(world, pos, ((CarvingBenchEntity) blockEntity));
    ...
    protected ItemActionResult onUseWithItem(ItemStack stack, BlockState state, World world, BlockPos pos,
        ...
        if (!world.isClient) {
            NamedScreenHandlerFactory screenHandlerFactory = ((CarvingBenchEntity) world.getBlockEntity(pos));
